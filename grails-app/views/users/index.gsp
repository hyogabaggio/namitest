		...
		<div id="list-users" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="dateCreated" title="${message(code: 'users.dateCreated.label', default: 'Date Created')}" />
				...
				<g:each in="${usersInstanceList}" status="i" var="usersInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${usersInstance.id}">${fieldValue(bean: usersInstance, field: "dateCreated")}</g:link></td>
